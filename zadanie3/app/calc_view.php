		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-7">
				<div class="row">
					...
					<div class="col-md-6">
						<form class="transfot" action="<?php print(_APP_ROOT); ?>/app/calc.php#calc" method="post">
							<div class="col-md-12">
								<span>Szybki i niezawodny</span>
								<h3>Kalkulator kredytowy</h3>
							</div>
							<div class="col-md-12">
								<input class="transfot_form" placeholder="Kwota kredytu" id="id_kwota_kredytu" type="text" name="kwota_kredytu" value="<?php out($kwota_kredytu) ?>" />
							</div>
							<div class="col-md-12">
								<input class="transfot_form" placeholder="Ilość rat" id="id_il_rat" type="text" name="il_rat" value="<?php out($il_rat); ?>" />
							</div>
							<div class="col-md-12">
								<input class="transfot_form" placeholder="Oprocentowanie" id="id_oprocentowanie" type="text" name="oprocentowanie" value="<?php out($oprocentowanie) ?>" />
							</div>
							<div class="col-md-12">
						...
						<div style="margin-top: 1em; padding: 1em; border-radius: 0.5em; background-color: #0f98f8; color: #fff; width:25em;">
							<?php echo 'Kwota do spłaty: '.$result.' PLN'; ?>
						</div>
						<?php } ?>
					</div>
				</div>
